...
Shader "Mtree/Leafs"
{
	...
	SubShader
	{
		...
		#pragma surface surf StandardCustom keepalpha exclude_path:deferred vertex:vertexDataFunc  finalcolor:finalColorFunc 
		struct Input
		{
			float2 uv_texcoord;
			half ASEVFace : VFACE;
		...
		void finalColorFunc(Input IN, SurfaceOutputStandardCustom o, inout fixed4 color)
		{
