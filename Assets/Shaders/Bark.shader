...
Shader "Mtree/Bark"
{
	...
	SubShader
	{
		...
		#pragma surface surf Standard keepalpha vertex:vertexDataFunc finalcolor:finalColorFunc
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 txAlbedo = tex2D( _MainTex, uv_MainTex );
			float4 break93 = txAlbedo;
			float clampResult70 = clamp( ( ( ( 0 /*i.vertexColor.r - _Height*/ ) + ( ( ( break93.r + break93.g + break93.b ) - 0.5 ) * _TextureInfluence ) ) / _Smooth ) , 0.0 , 1.0 );
			...
			o.Normal = lerp( lerpResult73 , UnpackScaleNormal( tex2D( _BumpMap, uv_BumpMap ), _BumpScale ) , (float)_BaseDetail);
			 
			o.Albedo = txAlbedo.rgb; // OUT_Albedo215.rgb;
			o.Metallic = _Metallic;
			o.Smoothness = lerp(0.0, txAlbedo.r, _Glossiness);
			o.Occlusion = _OcclusionStrength; // lerp(1.0, i.vertexColor.a, _OcclusionStrength);

			float txAlpha = txAlbedo.a;
				...
				float staticSwitch40_g22 = (txAlpha * dither45_g22 );
			#else
				float staticSwitch40_g22 = txAlpha;
			#endif
